...
{
    /// <summary>
    /// Provides methods for encoding and decoding data using specific cryptographic permutations.
    /// </summary>
    public static class DatatEncoder
    {
        ...
        /// <summary>
        /// Applies a permutation-based encoding or decoding operation on the specified byte array.
        /// </summary>
        /// <remarks>
        /// This method performs no operation if the encoding algorithm specified in the PST file header is set to <see cref="PSTHeader.BlockEncoding.NONE"/>.
        /// If the encoding algorithm is <see cref="PSTHeader.BlockEncoding.PERMUTE"/>, the method applies a permutation-based transformation to the specified byte array using an internal lookup table.
        /// </remarks>
        /// <param name="pv">The byte array to be encoded or decoded. The operation modifies this array in place.</param>
        /// <param name="cb">The number of bytes to process from the <paramref name="pv"/> array. Must be less than or equal to the length of <paramref name="pv"/>.</param>
        /// <param name="fEncrypt">A value indicating whether to perform encryption or decryption.  <see langword="true"/> to encrypt; <see langword="false"/> to decrypt.</param>
        /// <param name="pst">The PST file context that provides the encoding algorithm and related metadata.</param>
